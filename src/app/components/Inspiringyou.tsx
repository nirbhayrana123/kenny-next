...
export default function Inspiringyou() {
  return (
    <section className="hero-section">
            <div className="container" data-aos="fade-up" data-aos-duration="1500">
                ...
                <div className="client-logos">
                    ...
                    <img src="images/Brand-2-1.png" alt="Femmyou"/>
                    <img src="images//Brand-3-1.png" alt="KenePay"/>
                    <img src="images/Brand-4-1.png" alt="Assistalize"/>
                    <img src="images/Brand-5-1.png" alt="Kreatista"/>
                </div>
            </div>
        </section>
  )
